...
module.exports = function(app) {
	...
	setInterval(function() {
		...
		logger.debug('* Connected devices  : ' + Object.keys(devices.connected).length);
		logger.debug('* Active devices     : ' + Object.keys(devices.active()).length);
		logger.debug('* OnAir devices     : ' + Object.keys(devices.onAir()).length);
		logger.debug('*******************************');
